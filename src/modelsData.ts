...
export const RECOMMENDED_MODELS: Model[] = [
  ...
  },
  {
    ...
    sizeGB: 6.6,
    parameters: '2.6 Billion',
    description: 'Photorealistic and cinematic SDXL checkpoint for local creative workflows.',
  ...
  },
  {
    ...
    sizeGB: 6.5,
    parameters: '2.6 Billion',
    description: 'Anime-style SDXL text-to-image model for detailed local illustration workflows.',
...
const MODEL_LEGAL_INFO: Record<string, Omit<ModelLegalInfo, 'sourceUrl'>> = {
  ...
  'juggernaut-xl': { repository: 'RunDiffusion/Juggernaut-XL-v9', license: 'Open RAIL-M; no paid API hosting', licenseUrl: 'https://huggingface.co/RunDiffusion/Juggernaut-XL-v9' },
  'animagine-xl': { repository: 'cagliostrolab/animagine-xl-3.1', license: 'CreativeML Open RAIL++-M', licenseUrl: 'https://huggingface.co/cagliostrolab/animagine-xl-3.1' },
